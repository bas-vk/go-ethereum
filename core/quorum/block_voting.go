...
const definition = `[{"constant":false,"inputs":[{"name":"threshold","type":"uint256"}],"name":"setVoteThreshold","outputs":[],"type":"function"},{"constant":true,"inputs":[],"name":"voterCount","outputs":[{"name":"","type":"uint256"}],"type":"function"},{"constant":true,"inputs":[],"name":"voteThreshold","outputs":[{"name":"","type":"uint256"}],"type":"function"},{"constant":false,"inputs":[{"name":"addr","type":"address"}],"name":"removeVoter","outputs":[],"type":"function"},{"constant":true,"inputs":[{"name":"p","type":"uint256"},{"name":"n","type":"uint256"}],"name":"getEntry","outputs":[{"name":"","type":"bytes32"}],"type":"function"},{"constant":false,"inputs":[{"name":"hash","type":"bytes32"}],"name":"vote","outputs":[],"type":"function"},{"constant":true,"inputs":[{"name":"","type":"address"}],"name":"canVote","outputs":[{"name":"","type":"bool"}],"type":"function"},{"constant":true,"inputs":[],"name":"getSize","outputs":[{"name":"","type":"uint256"}],"type":"function"},{"constant":false,"inputs":[{"name":"addr","type":"address"}],"name":"addVoter","outputs":[],"type":"function"},{"constant":true,"inputs":[],"name":"getCanonHash","outputs":[{"name":"","type":"bytes32"}],"type":"function"},{"inputs":[],"type":"constructor"},{"anonymous":false,"inputs":[{"indexed":false,"name":"sender","type":"address"},{"indexed":false,"name":"blockNumber","type":"uint256"}],"name":"InvalidSenderVote","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"name":"sender","type":"address"},{"indexed":false,"name":"blockNumber","type":"uint256"},{"indexed":false,"name":"blockHash","type":"bytes32"}],"name":"Vote","type":"event"}]`
const RuntimeCode = ``
...
func deployVotingContract(db ethdb.Database) {
	...
	acc2 := core.GenesisAccount{common.HexToAddress("0xf0198772ee14eb039751d7b5121cb7f103d7a1a0"), balance, nil, nil}
	acc3 := core.GenesisAccount{common.HexToAddress("0xbbadd44f506214ddb6558c416b4b4ee19cf8d691"), balance, nil, nil}

	contract := core.GenesisAccount{contractAddress, new(big.Int), common.FromHex(RuntimeCode), map[string]string{
		common.Bytes2Hex(common.LeftPadBytes([]byte{1}, 32)):                                                                        common.Bytes2Hex(common.LeftPadBytes([]byte{2}, 32)), // vote threshold = 2
		common.Bytes2Hex(common.LeftPadBytes([]byte{2}, 32)):                                                                        common.Bytes2Hex(common.LeftPadBytes([]byte{3}, 32)), // voter count = 3
		common.Bytes2Hex(crypto.Keccak256(append(common.LeftPadBytes(masterAddr[:], 32), common.LeftPadBytes([]byte{3}, 32)...))):   "01",                                                 // add addr1 as a voter
		common.Bytes2Hex(crypto.Keccak256(append(common.LeftPadBytes(acc2.Address[:], 32), common.LeftPadBytes([]byte{3}, 32)...))): "01",                                                 // add acc2 as voter
		common.Bytes2Hex(crypto.Keccak256(append(common.LeftPadBytes(acc3.Address[:], 32), common.LeftPadBytes([]byte{3}, 32)...))): "01",                                                 // add acc3 as voter
	}}
...
func (bv *BlockVoting) createBlock() {
	...
	// 1. lookup canon hash from contract
	ch, err := bv.CanonHash()
	if err != nil {
		glog.V(logger.Debug).Infof("unable to retrieve canonical hash: %v", err)
		if tx, err := bv.Vote(bv.blockchain.CurrentBlock().Hash()); err == nil {
			bv.txpool.Add(tx)
		}
		return
	}
	...
	if ch == (common.Hash{}) {
		glog.V(logger.Debug).Infof("not (yet) enough votes to determine canonical head for new block creation, vote (again) for our head")
		if tx, err := bv.Vote(bv.blockchain.CurrentBlock().Hash()); err == nil {
			bv.txpool.Add(tx)
		}
		return
	...
	glog.V(logger.Debug).Infof("create new block on top of: %s", ch.Hex())

	// 2. if canonical hash is not within database return (should be enforced by the contract)
	parent := bv.blockchain.GetBlockByHash(ch)
	if parent == nil {
		glog.Errorf("parent block %s not found", ch.Hex())
		return
	}
	...
	nBlock, _, _, _, err := bv.create(parent, transactions)
	if err != nil {
